...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product_data['video'] = $request->video;
    ...
    public function edit(Product $product)
    {
        ...
        return view('admin.products.edit', compact('product','categories','sub_categories','child_categories','colors','images','productVariation','productColors','sizes', 'variations'));
    }
    ...
    public function update(UpdateProductRequest $request, Product $product)
    {
       ...
       $acollection = ProductAttribute::where('product_id', $product->id)->select('id')->get();
        ...
        $data_arr['product_image'] = $product_image;
        $data_arr['video'] = $request->video;
    ...
    {  
        return Excel::download(new ProductExport, 'sample_product.xlsx');
    }
