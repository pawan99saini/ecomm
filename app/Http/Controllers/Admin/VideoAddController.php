...
class VideoAddController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('image', function ($row) {
                ...
                if ($photo =  $row->video ? $row->video : '') {
                   ...
                   return '<div class="text-center"><a href="'.asset('public/file/videos').'/'.$photo.'" target="_blank"><video src="'.asset('public/file/videos').'/'.$photo.'" width="50px" height="50px" style="border : 2px solid lightgray; border-radius : 5px;"></a></div>
                   ';
                    // return sprintf(
    ...
    public function store(Request $request)
    {
       ...
       $vi->save();
        ...
        return redirect()->route('admin.video-add.index');
    }

    public function edit(VideoAdd $slider)
    {   
