                                    ...
                                    <div class="form-group" style="margin-top: 20px;width: 100%; display: inline-block;">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <label class="labeled thumbnail" data-toggle="tooltip" title="Upload product image">
                                                            <img class="avatar" id="" src="{{asset('assets/images/upload.png')}}" alt="avatar" width="100%" height="100">
                                        ...
                                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                            type="text" name="video" id="video" value="{{ old('video', '') }}"
                                            required>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.post("{{ url('backoffice/product/getpartials') }}", {
                'id': {{ $product->id ?? 0 }}
            }, function(n) {
                $('.ajax-content').html(n);
