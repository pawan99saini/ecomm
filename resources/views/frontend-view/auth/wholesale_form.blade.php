                ...
                <div class="loginregister-page register-wrap">
                  ...
                  <div class="loginregister-body">
                    <form method="post" action="{{ route('frontview.register') }}" id="registeration">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group required col-sm-6 col-12">
                          ...
                          <select class="form-control required" name="customer_type_id">
                    ...
                    <div class="loginregister-now">
                        ...
                        <a href="{{ url('wholesale_login') }}" class="account-link login">Sign in?</a>
                    </div>
                  </div>
              </div>
              </div>
...
function registeration(){
  ...
  if(r == 0){
    $('#cover-spin').show(0);
    $.post("{{ route('wholesale_site_submit') }}",form.serialize(),function(v){
      $('#cover-spin').hide(0);
        if(v.code == 200){
          ...
          window.setTimeout(function() {
              window.location.href = " {{route('wholesale_login')}} ";
          }, 5000);
        }else{
        ...
        if(n.responseJSON.errors){
            if(n.responseJSON.errors.email){
              notifyme('error',n.responseJSON.errors.email);
            }
            if(n.responseJSON.errors.mobile){
              notifyme('error',n.responseJSON.errors.mobile);
            }
        }else{
            notifyme('error','Something went wrong, Please try again later');
        }
