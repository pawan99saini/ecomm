                      ...
                      <tbody>
                        @foreach($rproducts as $product)
                          <tr>
                            ...
                            <td>
                              <span class="badge badge-secondary p-2">{{$product->category ? $product->category->name : ''}}</span>
                            </td>
                            <td>
                              <span class="badge badge-secondary p-2">{{$product->sub_category ? $product->sub_category->name : ''}}</span>
                            </td>
                            <td>
