...
<head>
    ...
    <link href="{{ asset('assets/vendor/css/daterangepicker.css') }}" rel="stylesheet" />
...
<div class="modal-dialog modal-lg" role="document">
    ...
    <script src="{{asset('assets/js/cropper.min.js')}}" type="text/javascript"></script>
 <script src="{{asset('assets/js/custom-crop.js')}}" type="text/javascript"></script>
