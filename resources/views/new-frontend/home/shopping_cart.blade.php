                    ...
                    <div class="basket-product-summary-wrapper">
                        ...
                        <div class="basket-product-secure-payment">
                            ...
                            <div class="payment-getway-icons mt-2">
                                <span class="visa"><img src="{{asset('front/images/payment-icons/visa.png')}}" /></span>
                                <span class="master"><img src="{{asset('front/images/payment-icons/master-card.png')}}" /></span>
                                <span class="paypal"><img src="{{asset('front/images/payment-icons/pay-pal.png')}}" /></span>
                            </div>
                        </div>
                    </div>
