...
<!--=====================================================
          ...
          <div class="row">
            ...
            <div class="content-area col-md-9 col-sm-12 col-12">
              <div class="content-section">
                ...
                <p>Today is a great day to check your account page. You can check <a href="<?php echo e(route('user.orders')); ?>">your last orders</a> or have a look to <a href="<?php echo e(route('user.wishlist')); ?>">your wishlist. </a><br>Or maybe you can <strong>start to shop</strong> and check our latest offers ?</p>
               <div class="row">                 
                    ...
                    <div class="box-body">
                      <a href="<?php echo e(route('user.orders')); ?>">
                        <div class="account-box-image">
                          <img onerror="handleError(this);"src="<?php echo e(asset('file')); ?>/icon-order.png" alt="">
                  ...
                  <div class="box-wrap box-radius box-border-bottom account-box">                              
                    <div class="box-body">
                      <a href="<?php echo e(route('user.profile')); ?>">
                        <div class="account-box-image">
                          <img onerror="handleError(this);"src="<?php echo e(asset('file')); ?>/icon-profile.png" alt="">
                        </div>
                        <h5>My Profile</h5>
                      </a>
                    </div>
                  ...
                  <div class="box-wrap box-radius box-border-bottom account-box">                              
                    <div class="box-body">
                      <a href="<?php echo e(route('user.wishlist')); ?>">
                        <div class="account-box-image">
                          <img onerror="handleError(this);"src="<?php echo e(asset('file')); ?>/icon-wishlist.png" alt="">
    ...
    <!--=====================================================
                        Site Section End
    =========================================================-->
<?php echo $__env->make('frontend-view.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecomm\resources\views/store/users/dashboard.blade.php ENDPATH**/ ?>