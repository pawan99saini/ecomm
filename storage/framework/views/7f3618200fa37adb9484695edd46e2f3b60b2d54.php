    ...
    <div class="row">
      <ul class="d-flex breadcrumb-menu">
        <li class="breadcrumb-item">
          <a class="underline-lite-on-hover position-relative" href="">home</a>
        </li>
        <li class="breadcrumb-item">
          <a class="underline-lite-on-hover position-relative" href="">category</a>
        </li>
        <li class="breadcrumb-item">
          <a class="underline-lite-on-hover position-relative" href="">category</a>
        </li>
...
<div class="cata-top-banner sticky-header-next-sec container position-relative text-center">
  <div class="row">
    ...
    <h1 class="cata-banner-title"><?php echo e($category->name); ?></h1>
  </div>
</div>
...
<div id="FilterSideNav" class="filterSidenav">
  <div class="filterSidenav-head">
    <span href="javascript:void(0)" class="closebtn" onclick="closeFilterSideNav()">&times;</span>
  </div>
  <div class="filterSidenav-body">
    ...
    <div class="filter-wrapper">
      <div class="filter-subtitle d-flex justify-content-between align-items-center">
        <span>Filter</span>
        <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#808080c9" viewBox="0 0 24 24">
            <path
        ...
        <div class="accordion filter-menu" id="price">
          <div class="card border-0">
            <div class="card-header p-0 border-0" id="priceHead">
              <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#price1"
                aria-expanded="true" aria-controls="price1">Price</a>
            </div>

            <div id="price1" class="collapse show" aria-labelledby="priceHead" data-parent="#price">
        ...
        <div class="accordion filter-menu" id="size">
          <div class="card border-0">
            <div class="card-header p-0 border-0" id="sizeHead">
              <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#size1" aria-expanded="true"
                aria-controls="size1">Size</a>
            </div>

            <div id="size1" class="collapse show" aria-labelledby="sizeHead" data-parent="#size">
              <div class="card-body p-0 mb-0 d-flex flex-column">
                <label class="custom-checkbox mb-1">
                  <input type="checkbox" />
                  <b></b>
        ...
        <div class="accordion filter-menu" id="color">
          <div class="card border-0">
            <div class="card-header p-0 border-0" id="colorHead">
              <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#color1" aria-expanded="true"
                aria-controls="color1">color</a>
            </div>

            <div id="color1" class="collapse show" aria-labelledby="colorHead" data-parent="#color">
              <div class="card-body p-0 mb-0 d-flex flex-column">
                <label class="custom-checkbox mb-1">
                  <input type="checkbox" />
                  <b></b>
        ...
        <div class="accordion filter-menu" id="style">
          <div class="card border-0">
            <div class="card-header p-0 border-0" id="styleHead">
              <a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#style1" aria-expanded="true"
                aria-controls="style1">style</a>
            </div>

            <div id="style1" class="collapse show" aria-labelledby="styleHead" data-parent="#size">
              <div class="card-body p-0 mb-0 d-flex flex-column">
                <label class="custom-checkbox mb-1">
                  <input type="checkbox" />
                  <b></b>
        ...
        <div class="col-12 text-uppercase">
          ...
          <div class="toolbar-product d-flex justify-content-between align-items-baseline">
            ...
            <div class="layout-changer">
              <span class="layout-changer-label" onclick="changeTwo()"><svg xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink" width="21px" height="20px" viewBox="0 0 21 20"
                  version="1.1">
                  <g id="Page-1" stroke="#9d9d9d" stroke-width="1" fill="#9d9d9d" fill-rule="evenodd">
                    <g id="Dribbble-Light-Preview" fill="#9d9d9d57" stroke="#9d9d9d00"
                      transform="translate(-99.000000, -200.000000)" fill="#000000">
              ...
              <span class="layout-changer-label" onclick="changeThree()">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="21px"
                  height="20px" viewBox="0 0 21 20" version="1.1">
                  <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="Dribbble-Light-Preview" fill="#9d9d9d57" stroke="#9d9d9d00"
                      transform="translate(-219.000000, -200.000000)" fill="#000000">
                      <g id="icons" transform="translate(56.000000, 160.000000)">
                        <path
          ...
          <div class="products_wrapper">
            <div class="row mb-3">
              ...
              <div class="productChange col-sm-6 col-md-6 col-lg-4 position-relative p-i-10 mb-3">
                ...
                <div class="mt-8px">
                  <a class="product-label" href=""><span><?php echo e($product->name); ?> </span></a>
...
<?php echo $__env->make('new-frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecomm\resources\views/new-frontend/home/category.blade.php ENDPATH**/ ?>