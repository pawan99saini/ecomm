                      ...
                      <tbody>
                        <?php $__currentLoopData = $rproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            ...
                            <td>
                              <span class="badge badge-secondary p-2"><?php echo e($product->category ? $product->category->name : ''); ?></span>
                            </td>
                            <td>
                              <span class="badge badge-secondary p-2"><?php echo e($product->sub_category ? $product->sub_category->name : ''); ?></span>
                            </td>
                            <td>
...
<?php echo $__env->make('new-frontend.layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecomm\resources\views/dashboard.blade.php ENDPATH**/ ?>