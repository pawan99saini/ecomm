...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/bootstrap.min-3.3.7.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/menu.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/style-new.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/fontawesome-all.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/front-new.css')); ?>">
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/front-new2.css')); ?>"> -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/zoom-slider.css')); ?>">
    <link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('toast/toastr.css')); ?>">
...
<body>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="Customer">
                                        <div class="formrow martop15 borbotnone">
                                            <div class="col-md-12 text-center">
                                                <a href="<?php echo e(url('/redirect/facebook')); ?>" class="btn btn-social btnfb"><i
                                                        class="fab fa-facebook-f"></i> <span class="divider"></span>
                                                    Login with Facebook</a>
                                                <a href="<?php echo e(url('/redirect/google')); ?>" class="btn btn-social btn-gmail"><i
                                        ...
                                        <div class="row">
                                            <form class="col-md-12" id="signup-user">
                                                <div class="formrow" action="<?php echo e(route('store.register')); ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="pad15">
                                ...
                                <div class="formrow martop15 borbotnone">
                                    <div class="col-md-12 text-center">
                                        <a href="<?php echo e(url('/redirect/facebook')); ?>" class="btn btn-social btnfb"><i class="fab fa-facebook-f"></i> <span
                                                class="divider"></span> Login with Facebook</a>
                                        <a href="<?php echo e(url('/redirect/goolge')); ?>" class="btn btn-social btn-gmail"><i class="fab fa-google"></i> <span
                                                class="divider"></span> Login with Google</a>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <form action="<?php echo e(route('store.login')); ?>" method="POST" id="login-form-submit">
                                        <div class="formrow">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-md-2 col-lg-2">
                                <div class="logo">
                                    <a href="<?php echo e(url('/')); ?>"><img onerror="handleError(this);"class="img-fluid"
                                            src="<?php echo e(asset('front_assets/images/vasvi_logo.jpg')); ?>" alt="" width="150" /></a>
                                </div>
                            </div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="dropdown-content account-dropdown">
                                                    ...
                                                    <ul class="user-details">
                                                        <li>
                                                            <p class="text-left"><i
                                                                    ...
                                                                    aria-hidden="true"></i> Hi, <?php echo e($user->name); ?></p>
                                                        </li>
                                                        <li>
                                                            <p class="text-left"><i
                                                        ...
                                                        <li>
                                                          <form method="POST" action="<?php echo e(route('store.logout')); ?>">
                                                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="<?php echo e(url('/redirect/facebook')); ?>"><img
                                                                    src="<?php echo e(asset('front_assets/images/facebook-svg.svg')); ?>"
                                                                    alt="" width="220" /></a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo e(url('/redirect/google')); ?>"><img
                                                                    src="<?php echo e(asset('front_assets/images/google-svg.svg')); ?>"
                                                                    alt="" width="220" /></a>
                                                        </li>
                                        ...
                                        <div class="collapse" id="collapseExample">
                                          <ul class=" user-details">
                                             <div class="">
                                                ...
                                                <li>
                                                   <div class="maindiv">
                                                 <div class="img-boxs"><img onerror="handleError(this);"src="<?php echo e(asset('front_assets/images/1a.jpg')); ?>"></div>
                                                 <div class="cart-content">
                                                    <h2><a href="#">Women garments</a></h2>
                                                   <p> RS 2,229.97 <span>Quantity: 01</span></p>
                                                 </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <ul class="we-accept-img">
                        <li>
                            <a href="#"><img onerror="handleError(this);"class="img-fluid" src="<?php echo e(asset('front_assets/images/payment.png')); ?>"
                                    alt="payments"></a>
                        </li>
                    </ul>
                </div>
                        ...
                        <ul class="Secure-pay">
                            <li>
                                <a href="#"><img onerror="handleError(this);"class="img-responsive"
                                        src="<?php echo e(asset('front_assets/images/SSL_Secure.png')); ?>" alt="payments"></a>
                            </li>
                            <li>
                                <a href="#"><img onerror="handleError(this);"class="img-responsive"
                                        src="<?php echo e(asset('front_assets/images/ssl-secure-shopping.png')); ?>" width="80px"
                                        alt="payments"></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="footer_column">
                        ...
                        <ul class="contact-info">
                            ...
                            <li> <a href="#" target="_blank"><img onerror="handleError(this);"alt="whatsapp"
                                        src="<?php echo e(asset('front_assets/images/whatsapp-icon.png')); ?>"
  ...
  <div class="modal" id="myModal">
    ...
    <script src="<?php echo e(asset('front_assets/js/slimscroll.js')); ?>"></script>
    <script src="<?php echo e(asset('front_assets/js/jquery.slimscroll.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front_assets/js/owl.carousel.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front_assets/js/megamenu.js')); ?>"></script>
    <script src="<?php echo e(asset('front_assets/js/zoom-slider.js')); ?>"></script>
    <script src="<?php echo e(asset('front_assets/js/zoom-slider-main.js')); ?>"></script>
    ...
    $(document).on('click','#verify', function(e){
      ...
      if(otp === ''){
        ...
        if(otp === check_otp){
           $.ajax({
                   type : 'POST',
                   url: '<?php echo e(route('store.register')); ?>',
    ...
    $(document).on('submit','#signup-user',function(e){
       e.preventDefault()
        ...
        if(!error){
          ...
          $.ajax({
                  type : 'POST',
                  url: '<?php echo e(route('store.sendotp')); ?>',
                  data : {mobile : mobile},
                  success : function(response)
                  {
                    console.log(response);
...
<?php /**PATH C:\wamp64\www\ecomm\resources\views/layouts/front.blade.php ENDPATH**/ ?>