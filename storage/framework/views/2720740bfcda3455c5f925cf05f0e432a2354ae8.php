<?php $__env->startSection('content'); ?>
     <link rel="stylesheet" href="<?php echo e(asset('front/css/Product.css')); ?>"/>
<link rel="stylesheet" href="<?php echo e(asset('front/js/vendor/fancybox/jquery.fancybox.css')); ?>" />
  <link rel="stylesheet" href="<?php echo e(asset('front/js/vendor/fancybox/helpers/jquery.fancybox-thumbs.css')); ?>" /> 
        ...
        <div class="col-sm-12 col-md-12 col-lg-7">
          <div class="pdp-image-gallery-block">
            ...
            <div class="gallery_pdp_container">
              <div id="gallery_pdp">
                <div class="row">
                  <div class="col-3"> <a href="#" data-image="<?php echo e(asset('front/images/small/image1.png')); ?>" data-zoom-image="<?php echo e(asset('front/images/large/image1.jpg')); ?>">
                    <img id="" src="<?php echo e(asset('front/images/thumb/image1.jpg ')); ?>" /></a>
                  </div>
                  <div class="col-3"><a href="#" data-image="images/small/image2.png" data-zoom-image="<?php echo e(asset('front/images/large/image2.jpg ')); ?>">
                    <img id="" src="<?php echo e(asset('front/images/thumb/image2.jpg')); ?>" /></a>
                  </div>
                  <div class="col-3"><a href="#" data-image="<?php echo e(asset('front/mages/small/image3.png')); ?>" data-zoom-image="<?php echo e(asset('front/images/large/image3.jpg')); ?>">
                    <img id="" src="<?php echo e(asset('front/images/thumb/image3.jpg')); ?>" /></a>
                  </div>
                  <div class="col-3"><a href="#" data-image="<?php echo e(asset('front/images/small/image4.png')); ?>" data-zoom-image="<?php echo e(asset('front/images/large/image4.jpg')); ?>">
                    <img id="" src="<?php echo e(asset('front/images/thumb/image4.jpg')); ?>" /></a>
                  </div> 
                </div> 
              </div>
            ...
            <div class="gallery-viewer" data-scale="2.5">
              <img class="gallery-viewer-img" id="zoom_10" src="<?php echo e(asset('front/images/small/image1.png')); ?>" data-zoom-image="<?php echo e(asset('front/images/large/image1.jpg')); ?>" />
            </div>
          ...
          <div class="swiper mySwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide d-flex flex-column">
                <div>
                  <img src="<?php echo e(asset('front/images/product-image/p1.jpg')); ?>" />
                </div>                
...
<!-- Featured Product -->
    <script src="<?php echo e(asset('front/js/vendor/jquery/jquery-ui.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/fancybox/jquery.fancybox.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/elevatezoom/jquery.elevatezoom.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/panZoom/panZoom.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/ui-carousel/ui-carousel.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/zoom.js')); ?>"></script>
	<!-- Quantity Counter-->
      <script>
...
<?php echo $__env->make('new-frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecomm\resources\views/new-frontend/home/product.blade.php ENDPATH**/ ?>