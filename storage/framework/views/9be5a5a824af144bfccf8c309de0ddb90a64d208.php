    ...
    <div class="row bg-light my-2" id="select-bg">
        <div class="col-12 text-center bg-light">
            ...
            <a class="btn btn-primary float-right" href="<?php echo e(route('admin.products.create')); ?>"
                    ...
                    <a class="btn btn-primary float-right" href="<?php echo e(url('secure_admin/product/file-import-export')); ?>"
                        style="border-radius : 25px;color:white !important">
                        Product Import
                    </a>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecomm\resources\views/admin/products/index.blade.php ENDPATH**/ ?>