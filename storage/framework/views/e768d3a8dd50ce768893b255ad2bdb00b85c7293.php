    ...
    <section class="ec-banner section section-space-p iconic">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 margin-b-30" data-animation="fadeIn">
                    <div class="iconic-box">
                        <video width="" height="" style="height: 100%;" autoplay loop muted controls="false">
                            <source src="<?php echo e(asset('front/video/1.mp4')); ?>" type="video/mp4">
                ...
                <div class="col-lg-4 col-md-6 margin-b-30" data-animation="fadeIn">
                    <div class="iconic-box">
                        <img src="<?php echo e(asset('front/images/product-image/img1.jpg')); ?>" alt="" />
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 margin-b-30" data-animation="fadeIn">
                    <div class="iconic-box">
                        <img src="<?php echo e(asset('front/images/product-image/img2.jpg')); ?>" alt="" />
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 margin-b-30 text-center" data-animation="fadeIn">
                    <div class="iconic-box pt-3 px-3">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 text-center mb-5" data-animation="fadeInUp">
                    ...
                    <video width="" height="" style="width:100%" controls autoplay loop muted>
                        <source src="<?php echo e(asset('front/video/2.mp4')); ?>" type="video/mp4">
                        Your browser does not support the video tag.
                    </video><br /><br />
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6 margin-b-30">
                    <div class="iconic-box h-auto" data-animation="fadeInUp">
                        ...
                        <div class="iconic-box2-content">
                            ...
                            <img class="my-3" width="100" src="<?php echo e(asset('front/images/icons/icon-divider-dark.svg')); ?>" alt="" />
                    ...
                    <div class="iconic-box" style="height:360px;" data-animation="fadeInUp">
                        <img src="<?php echo e(asset('front/images/product-image/img4.jpg')); ?>" alt="" />
                        <div class="iconic-box2-content">
                            <h4 class="font-weight-bold w-100 text-white">Lorem Ipsum</h4>
                            <img class="my-3" width="100" src="<?php echo e(asset('front/images/icons/icon-divider-dark.svg')); ?>" alt="" />
                            <p class="w-100 text-white">Lorem Ipsum is dummy text</p>
                ...
                <div class="col-lg-5 col-md-6 margin-b-30" data-animation="fadeInUp">
                    ...
                    <div class="iconic-box h-auto" data-animation="fadeInUp">
                        <img src="<?php echo e(asset('front/images/product-image/img3.jpg')); ?>" alt="" />
                        <div class="iconic-box2-content">
                            <h4 class="font-weight-bold w-100 text-white">Lorem Ipsum</h4>
                            <img class="my-3" width="100" src="<?php echo e(asset('front/images/icons/icon-divider-dark.svg')); ?>" alt="" />
                            <p class="w-100 text-white">Lorem Ipsum is dummy text</p>
                    ...
                    <div class="insta-auto">
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="<?php echo e(asset('front/images/instragram-image/3.jpg')); ?>"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
            ...
            <div id="ec-popnews-box">
                <div class="row">
                    ...
                    <div class="col-md-6 disp-no-767">
                        <img src="<?php echo e(asset('front/images/banner/4.jpg')); ?>" alt="newsletter">
                    </div>
...
<?php echo $__env->make('new-frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecomm\resources\views/new-frontend/home/index.blade.php ENDPATH**/ ?>