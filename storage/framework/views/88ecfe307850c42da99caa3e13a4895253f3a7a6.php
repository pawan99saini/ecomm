...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" enctype="multipart/form-data" id="product-form">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-3">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>"
                                            type="text" name="name" id="name" value="<?php echo e(old('name', '')); ?>"
                                            required>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('sku_code') ? 'is-invalid' : ''); ?>"
                                            type="text" name="sku_code" id="sku_code" value="<?php echo e(old('sku_code', '')); ?>"
                                            required style='text-transform:uppercase'>
                                        <!-- get_sku(12) -->
                                        <?php if($errors->has('sku_code')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('sku_code')); ?></span>
                                        <?php endif; ?>
                                        <span class="help-block"><?php echo e(trans('cruds.product.fields.sku_code_helper')); ?>
                                    ...
                                    <div class="form-group col-4">
                                        <label for="tax_rate" class="required"><?php echo e(trans('cruds.product.fields.tax_rate')); ?></label>

                                        <input class="form-control <?php echo e($errors->has('tax_rate') ? 'is-invalid' : ''); ?>"
                                            type="number" name="tax_rate" id="tax_rate"
                                            value="<?php echo e(old('tax_rate', '')); ?>" step="0.01">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <select
                                            ...
                                            <option value="" disabled
                                                <?php echo e(old('discount_type', null) === null ? 'selected' : ''); ?>>
                                            ...
                                            <?php $__currentLoopData = App\Models\Product::DISCOUNT_TYPE_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>"
                                                    <?php echo e(old('discount_type', '0') == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($label); ?>
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('discount') ? 'is-invalid' : ''); ?>"
                                            ...
                                            value="<?php echo e(old('discount', '')); ?>" step="0.01">
                                    ...
                                    <div class="col-3">
                                        <div
                                            ...
                                            <input type="checkbox" name="is_exclusive" id="is_exclusive" value="1"
                                                <?php echo e(old('is_exclusive', 0) == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-3">
                                        <div class="icheck-primary <?php echo e($errors->has('is_new') ? 'is-invalid' : ''); ?>">
                                            <input type="checkbox" name="is_new" id="is_new" value="1"
                                                <?php echo e(old('is_new', 0) == 1 ? 'checked' : ''); ?>>
                                            <label for="is_new">
                                    ...
                                    <div class="col-3">
                                        <div
                                            ...
                                            <input type="checkbox" name="is_sho_by_look" id="is_sho_by_look"
                                                value="1" <?php echo e(old('is_sho_by_look', 0) == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-3">
                                        <div class="icheck-primary <?php echo e($errors->has('is_popular') ? 'is-invalid' : ''); ?>">
                                            <input type="checkbox" name="is_popular" id="is_popular" value="1"
                                                <?php echo e(old('is_popular', 0) == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <!--<div class="col-3">-->
                                    <!--    <div class="icheck-primary <?php echo e($errors->has('is_sale') ? 'is-invalid' : ''); ?>">-->
                                    <!--        <input type="checkbox" name="is_sale" id="is_sale" value="1"-->
                                    <!--            <?php echo e(old('is_sale', 0) == 1 ? 'checked' : ''); ?>>-->
                                    <!--        <label for="is_sale">-->
                                    <!--            <?php echo e(trans('cruds.product.fields.is_sale')); ?>-->
                                    <!--        </label>-->
                                    <!--    </div>-->

                                    <!--    <?php if($errors->has('is_sale')): ?>
    -->
                                    <!--        <span class="text-danger">-->
                                    <!--            <?php echo e($errors->first('is_sale')); ?>-->
                                    <!--        </span>-->
                                    <!--
    <?php endif; ?>-->

                                    <!--    <span class="help-block">-->
                                    <!--        <?php echo e(trans('cruds.product.fields.is_sale_helper')); ?>-->
                                    <!--    </span>-->
                                    <!--</div>-->
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <select class="form-control <?php echo e($errors->has('status') ? 'is-invalid' : ''); ?>"
                                            ...
                                            <option value="" disabled
                                                <?php echo e(old('status', null) === null ? 'selected' : ''); ?>>
                                                <?php echo e(trans('global.pleaseSelect')); ?>
                                            ...
                                            <?php $__currentLoopData = App\Models\Product::STATUS_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>"
                                                    <?php echo e(old('status', 1) == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($label); ?>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea class="form-control desc <?php echo e($errors->has('care_and_disclaimer') ? 'is-invalid' : ''); ?>" name="care"
                                            id="editor"><?php echo old('care_and_disclaimer'); ?></textarea>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea class="form-control detail editor-details <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>"
                                            name="details" id="detail" required><?php echo old('description'); ?></textarea>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea class="form-control desc <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>" name="description"
                                            id="editor" required><?php echo old('description'); ?></textarea>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea class="form-control desc <?php echo e($errors->has('need_help') ? 'is-invalid' : ''); ?>" name="need_help"
                                            id="need_help" required><?php echo old('need_help'); ?></textarea>
                                    ...
                                    <!--<div class="form-group col-6">
                                            <label for="return" class="required">
                                                <?php echo e(trans('cruds.product.fields.return')); ?>

                                            </label>

                                            <textarea class="form-control desc <?php echo e($errors->has('return') ? 'is-invalid' : ''); ?>" name="return" id="editor"
                                                required><?php echo old('return'); ?></textarea>

                                            <?php if($errors->has('return')): ?>
    <span class="text-danger">
                                                    <?php echo e($errors->first('return')); ?>
...
*/
            ...
            $(document).on('keyup', '#sku_code', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('backoffice/products/checksku')); ?>/" + sku_code,
                    data: {},
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecomm\resources\views/admin/products/create.blade.php ENDPATH**/ ?>