...
<head>
    ...
    <!-- css Icon Font -->
    <link rel="stylesheet" href="<?php echo e(asset('front/css/vendor/ecicons.min.css')); ?>" />
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
    <script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"></script>
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    <script src="<?php echo e(asset('front/js/Sidenav.js')); ?>"></script>

    <!-- css All Plugins Files -->
    <link rel="stylesheet" href="<?php echo e(asset('front/css/plugins/animate.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/plugins/swiper-bundle.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/plugins/jquery-ui.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/plugins/countdownTimer.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/plugins/slick.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/plugins/bootstrap.css')); ?>" />

    <!-- Main Style -->
    <link rel="stylesheet" href="<?php echo e(asset('front/css/demo1.css')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('front/css/Hover.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/Currency-switcher.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/categoryStyle.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/SignUp.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('front/css/Login.css')); ?>" />
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            <div class="header-logo">
                                <a href="index.html"><img src="<?php echo e(asset('front/images/logo/logo.png')); ?>" alt="Site Logo" /></a>
                            </div>
                        </div>
                                        ...
                                        <li>
                                            <ul class="ec-main-banner w-100">
                                                <li><a class="p-0" href="javascript:void(0)"><img class="img-responsive"
                                                            src="<?php echo e(asset('front/images/menu-banner/1.jpg')); ?>" alt=""></a></li>
                                                <li><a class="p-0" href="javascript:void(0)"><img class="img-responsive"
                                                            src="<?php echo e(asset('front/images/menu-banner/2.jpg')); ?>" alt=""></a></li>
                                                <li><a class="p-0" href="javascript:void(0)"><img class="img-responsive"
                                                            src="<?php echo e(asset('front/images/menu-banner/3.jpg')); ?>" alt=""></a></li>
                                                <li><a class="p-0" href="javascript:void(0)"><img class="img-responsive"
                                                            src="<?php echo e(asset('front/images/menu-banner/4.jpg')); ?>" alt=""></a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li><a href="javascript:void(0)">Shop</a>
                            <ul class="sub-menu">
                                ...
                                <li><a class="p-0" href="javascript:void(0)">
                                        <img class="img-responsive" src="<?php echo e(asset('front/images/menu-banner/1.jpg')); ?>" alt=""></a>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="javascript:void(0)" class="sidekka_pro_img"><img
                                src="<?php echo e(asset('front/images/product-image/6_1.jpg')); ?>" alt="product"></a>
...
<?php echo $__env->yieldContent('content'); ?>
                ...
                <div class="ec-nav-panel-icons">
                    <a href="#ec-mobile-menu" class="navbar-toggler-btn ec-header-btn ec-side-toggle">
                        <img style="filter: invert(18%) sepia(55%) saturate(5235%) hue-rotate(343deg) brightness(85%) contrast(88%);"
                            src="<?php echo e(asset('front/images/icons/menu.svg')); ?>" class="svg_img header_svg" alt="icon" /></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#ec-side-cart" class="toggle-cart ec-header-btn ec-side-toggle"><img
                            src="<?php echo e(asset('front/images/icons/cart.svg')); ?>" class="svg_img header_svg" alt="icon" /><span
                            class="ec-cart-noti ec-header-count cart-count-lable">3</span></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="index.html" class="ec-header-btn"><img src="<?php echo e(asset('front/images/icons/home.svg')); ?>"
                            class="svg_img header_svg" alt="icon" /></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#" class="ec-header-btn"><img src="<?php echo e(asset('front/images/icons/wishlist.svg')); ?>"
                            class="svg_img header_svg" alt="icon" /><span class="ec-cart-noti">4</span></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#" class="ec-header-btn"><img src="<?php echo e(asset('front/images/icons/account.svg')); ?>"
                            class="svg_img header_svg" alt="icon" /></a>
                </div>
    ...
    <script src="<?php echo e(asset('front/js/vendor/jquery.notify.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/jquery.bundle.notify.min.js')); ?>"></script>

    <script src="<?php echo e(asset('front/js/vendor/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/jquery-migrate-3.3.0.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/modernizr-3.11.2.min.js')); ?>"></script>

    <!--Plugins JS-->
    <script src="<?php echo e(asset('front/js/plugins/swiper-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/plugins/countdownTimer.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/plugins/scrollup.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/plugins/jquery.zoom.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/plugins/slick.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/plugins/infiniteslidev2.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/vendor/jquery.magnific-popup.min.js')); ?>"></script>
    <script src="<?php echo e(asset('front/js/plugins/jquery.sticky-sidebar.js')); ?>"></script>

    <!-- Main Js -->
    <script src="<?php echo e(asset('front/js/vendor/index.js')); ?>"></script>
...
</html><?php /**PATH C:\wamp64\www\ecomm\resources\views/new-frontend/layout/app.blade.php ENDPATH**/ ?>