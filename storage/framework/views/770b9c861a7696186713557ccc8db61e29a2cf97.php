        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('admin.media.search')); ?>" >
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-lg-10">
                                ...
                                <?php if($search!=""){ ?>
                                    <div class="col-lg-1">
                                        <a class="btn btn-danger btn btn-block" href="<?php echo e(route('admin.media')); ?>">Reset</a>
                                    </div>
                                <?php } ?>
                            </div>
                        </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-md-2 margin-bottomset py-2">
                                <div class="img-thumbnail thumbnail-imges  ">
                                    <input type="checkbox" id="myCheckbox<?php echo e($image->id); ?>" data-id="<?php echo e($image->id); ?>"/>
                                      <label for="myCheckbox<?php echo e($image->id); ?>" id="mychklabel">
                                        <img onerror="handleError(this);"class="box-image px-2 py-2" image_id="" src="<?php echo e(asset("file")); ?>/<?php echo e($image->name); ?>" alt="..." >
                                    </label>
                                </div>
                                <button class="btn btn-block btn-secondary" id="view-btn" style="border : 2px solid #5A6268;border-radius: 0px 0px 5px 5px !important;" data-id="<?php echo e($image->id); ?>"> View Detail</button>
                            </div>
         ...
         <div class="modal-header text-center">
          ...
          <div class="modal-body">
            <div class="upload-box h-100" >
                <form action="<?php echo e(route('admin.media.store')); ?>" method="POST" enctype="multipart/form-data" class="dropzone w-100" id='image-upload'>
                    <?php echo csrf_field(); ?>
                    <div class="w-100">
...
<script>
    ...
    $(document).on('click','#view-btn',function(e){
        ...
        $.ajax({
           type:'GET',
           url:"<?php echo e(url('backoffice/media/view')); ?>"+"/"+id,
           data:{},
           success:function(data){
              var img = new Image();
              img.src = "<?php echo e(asset('file')); ?>"+ "/" + data.data.name;
    ...
    $(document).on('click','#btn-delete', function(){
        ...
        if(error){
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(url('backoffice/media/delete')); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ecomm\resources\views/admin/media/index.blade.php ENDPATH**/ ?>