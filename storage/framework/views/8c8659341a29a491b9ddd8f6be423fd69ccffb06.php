...
<head>
    ...
    <link href="<?php echo e(asset('assets/vendor/css/daterangepicker.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('assets/css/cropper.min.css')); ?>" rel="stylesheet" />
    <style>
        #cover {
...
<div class="modal-dialog modal-lg" role="document">
    ...
    <script src="<?php echo e(asset('assets/vendor/js/daterangepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('toast/toastr.min.js')); ?>"></script>

    <script src="<?php echo e(asset('assets/js/custom.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/cropper.min.js')); ?>" type="text/javascript"></script>
 <script src="<?php echo e(asset('assets/js/custom-crop.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH C:\wamp64\www\ecomm\resources\views/new-frontend/layout/admin.blade.php ENDPATH**/ ?>